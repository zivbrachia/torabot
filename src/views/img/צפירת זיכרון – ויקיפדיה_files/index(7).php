...
function addNavTip() {
    ...
    navTipMain.className = (currentSkin == "vector") ? "portal" : "portlet";
    ...
    navTipBody.className = (currentSkin == "vector") ? "body" : "pBody";
    ...
    if ( currentSkin == "vector" ) listItem.style.cssText = "margin-left:0.75em;";
     else
    {
